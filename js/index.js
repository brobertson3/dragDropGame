...
var currentOccupant = [null, null, null];
var correctAnswers = [drag2, drag1, drag3];
var totalAnswers = 0;
...
function mouseUp (e) {
	 ...
	 */
	 ...
	 if (trueTop >= (drop1.offsetTop - 50) && trueTop <= (drop1.offsetTop + 50) &&
	 	trueLeft <= (drop3.offsetLeft + 50) && trueLeft >= (drop1.offsetLeft - 50)) {
	 ...
	 function checkAnswers () {
		...
		function restartGame() {
			currentOccupant = [null, null, null];
			totalAnswers = 0;
		...
		if (correct === 3) {
			document.getElementById('response').textContent = 'Horray, you won!';
			document.getElementById('check-answers').classList.add('hidden');
			document.getElementById('play-again').classList.remove('hidden');
			document.getElementById('play-again').addEventListener('click', restartGame);
		} else {
			document.getElementById('response').textContent = (3 - correct) + " are incorrect, but I can't tell you which ones. Keep trying!";;
		}
	 }
	  ...
	  */
	if (totalAnswers === 3) { // answers complete
